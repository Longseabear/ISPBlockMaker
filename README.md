...
[GitHub Releases](https://github.com/Longseabear/ISPBlockMaker/releases/tag/v0.1.1)에서 `ISPBlockMaker-Setup.exe`를 내려받아 설치하세요. Windows x64용이며 Node와 서버 의존성이 포함되어 별도 npm 설치가 필요하지 않습니다. 예제와 사용자 워크스페이스는 포함하지 않습니다.
